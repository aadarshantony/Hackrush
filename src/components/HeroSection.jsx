    ...
    return (
        <main ref={container} id='home' className="relative grow flex flex-col items-center justify-center text-center px-4 pt-20 min-h-screen overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center">
                ...
                <p className="hero-sub text-gray-400 mb-10 max-w-xl mx-auto text-lg max-sm:text-sm">A 16-hour hackathon by <span className="text-cyan-400 font-bold">Etcetera Club</span> & <span className="text-cyan-400 font-bold">IEDC</span>, MGMCET Pampakuda</p>
                ...
                <div className="hero-date inline-block mb-10 px-8 py-3 max-sm:py-2 rounded-full border border-cyan-500/30 bg-cyan-900/10 backdrop-blur-sm shadow-[0_0_20px_rgba(6,182,212,0.15)]">
                    <span className="text-cyan-300 text-lg font-display tracking-wider max-sm:text-sm">JANUARY 23, 24 · 2026</span>
                </div>
