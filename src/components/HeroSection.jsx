        ...
        <main ref={container} id='home' className="relative grow flex flex-col items-center justify-center text-center px-4 pt-20 min-h-screen overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center">
                ...
                <p className="hero-sub text-gray-400 mb-8 max-w-xl mx-auto text-lg max-sm:text-sm leading-relaxed">
                    A 16-hour hackathon by <span className="text-cyan-400 font-bold">Etcetera Club</span> & <span className="text-cyan-400 font-bold">IEDC</span>, MGMCET Pampakuda
                </p>
                ...
                <div className="hero-date inline-block mb-10 px-8 py-3 max-sm:py-2 rounded-full border border-cyan-500/30 bg-cyan-900/10 backdrop-blur-sm shadow-[0_0_20px_rgba(6,182,212,0.15)]">
                    <span className="text-cyan-300 text-lg font-display tracking-wider max-sm:text-sm uppercase font-bold italic">JANUARY 23, 24 · 2026</span>
                </div>
                ...
                <div className="hero-prize bg-white/[0.03] border border-white/10 backdrop-blur-md px-10 py-5 rounded-2xl">
                    <p className="text-gray-400 text-xs md:text-sm font-medium uppercase tracking-[0.2em] mb-1">
                        Total Rewards Worth <span className="text-transparent bg-clip-text bg-linear-to-r from-cyan-400 via-white to-purple-400 font-black text-xl md:text-2xl drop-shadow-[0_0_10px_rgba(34,211,238,0.4)]">₹2,00,000+</span>
                    </p>
                    <p className="text-gray-500 text-[10px] md:text-xs font-bold uppercase tracking-[0.1em]">
            PLUS <span className="text-white font-black underline decoration-cyan-500/50 underline-offset-4">₹10,000 CASH</span> PRIZE POOL
        </p>
                </div>
            </div>
        </main>
